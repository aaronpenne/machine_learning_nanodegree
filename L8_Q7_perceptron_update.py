...
#
# (c) Udacity
# Forum post: https://discussions.udacity.com/t/perceptron-update/184989
# 
...
class Perceptron:
    ...
    def update(self, values, train, eta=.1):
        ...
        # For each data point:
        for data_point in range(len(values)):  # Updated xrange to range
            ...
            weight_update = np.dot(error, values[data_point]) * eta
